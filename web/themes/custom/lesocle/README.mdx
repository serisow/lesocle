...
lesocle theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of lesocle theme and run the following commands:
`nvm use`
...
`drush en lesocle -y`
`drush config-set system.theme default lesocle -y`
